...
To update this Wiki just send a Pull Request, I'll update both whenever I approve anything!

## Folder Meanings

* `WikiPages` refers to Pages on the Wiki, all files should be `.md` files and again adhere to existing Page Standards.
* `WikiAssets` refers to any Images a Wiki Page may need to reference, any and all images, gifs, or whatever are to be placed within this folder if it is required for this wiki, and isn't already available externally. (When referencing utilize the RAW GitHub URL)
